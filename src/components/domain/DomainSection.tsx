...
import { Brain, Video, FileSearch, Target, Cpu, Database, Zap, TrendingUp, Users, BarChart3, Lightbulb, Code, Server, Layout } from 'lucide-react';
  ...
  const technologies = [
    {
      ...
      description: "Predictive analytics for skill demand forecasting and personalized job recommendations",
      icon: Zap,
    ...
    },
    {
      ...
      description: "Comprehensive technical evaluation and skill assessment platform",
      icon: Cpu,
      ...
      techGroups: [
        {
          ...
          technologies: ["Haar Cascade Classifier", "Grayscale Conversion", "Resizing (48×48)", "Histogram Enhancement"]
        },
        {
          category: "Natural Language Processing",
          technologies: ["NLTK (Tokenization, Stopword Removal, Lemmatization)", "Regex", "Dictionary-based Correction"]
        },
        {
          category: "Video & Text Analysis",
          technologies: ["Frame Sampling (every 10th frame)", "Cosine Similarity", "Sentence Embeddings"]
        }
      ]
    }
  ];
              ...
              <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
                <div className="flex items-center justify-between text-sm text-gray-600">
                  ...
                  <span className="flex items-center">
                    ...
                    {tech.techGroups.flatMap(g => g.technologies).length} Technologies
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-16">
                ...
                <div className="space-y-6 text-gray-700 leading-relaxed">
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mt-8">
                    <div className="bg-cyan-50 p-6 rounded-lg border-l-4 border-cyan-500">
                      ...
                      <p className="text-sm">
                        Studies by the World Economic Forum highlight the growing skills gap in the IT sector,
                    ...
                    <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-500">
                      ...
                      <p className="text-sm">
                        Recent advancements in NLP and computer vision have enabled more sophisticated
                        candidate evaluation methods, transforming traditional recruitment practices.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-500">
                      <p className="text-gray-800 leading-relaxed text-sm">
                        Through comprehensive analysis, we identified significant gaps in current recruitment
                        technologies. Most solutions address isolated aspects without providing integrated,
                        end-to-end frameworks that combine resume analysis, skill assessment, video interview
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-cyan-50 p-4 rounded-lg">
                        <h4 className="font-bold text-gray-800 mb-2 text-sm">Job Seeker Challenges</h4>
                      ...
                      <div className="bg-orange-50 p-4 rounded-lg">
                        <h4 className="font-bold text-gray-800 mb-2 text-sm">Recruiter Challenges</h4>
                        <ul className="text-gray-700 text-xs space-y-1">
                  ...
                  {[
                    {
                      ...
                      description: "Design and implement an AI-powered resume analyzer to extract, score, and match candidate profiles with job requirements using advanced NLP techniques.",
                      icon: FileSearch
                    },
                    {
                      number: "02",
                      title: "Skill-Based Assessment Framework",
                      description: "Develop comprehensive skill evaluation modules featuring gamified quizzes, coding challenges, and technical assessments with real-time performance analytics.",
                      icon: Target
                    },
                    {
                      number: "03",
                      title: "Video Interview Analysis",
                      description: "Incorporate computer vision and speech analysis technologies to assess candidates' communication skills, confidence, and cultural fit.",
                      icon: Video
                    },
                    {
                      number: "04",
                      title: "AI-Powered Job Matching",
                      description: "Automate real-time job-candidate matching using sophisticated machine learning algorithms considering skills, experience, and cultural fit.",
                      icon: Brain
                    },
                    {
                      number: "05",
                      title: "AI-Agent for Smart Job Search",
                      description: "Design an AI Skill Forecaster that analyzes IT job postings to predict the top 5 most in-demand skills for the next 6 months.",
                      icon: Zap
                    }
                  ].map((objective, index) => (
                    <div key={index} className="flex items-start bg-gray-50 p-6 rounded-lg border border-gray-200 group hover:border-cyan-300 transition-colors">
              ...
              <section className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <p className="text-gray-600 text-sm text-center mt-4">
                  Figure 1: Comprehensive system architecture integrating multiple AI modules for end-to-end recruitment optimization
                </p>
              </section>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Technical Components</h3>
                <div className="space-y-3">
                  {[
                    ...
                    { name: "Time-Series Forecasting", color: "bg-orange-100 text-orange-800" },
                    { name: "Real-time Analytics", color: "bg-cyan-100 text-cyan-800" }
                  ].map((tech, index) => (
                    <span key={index} className={`inline-block ${tech.color} px-3 py-1 rounded-full text-xs font-medium mr-2 mb-2`}>
                      {tech.name}
                    </span>
                  ))}
                </div>
              ...
              <div className=" from-cyan-600 to-cyan-700 rounded-2xl p-6 text-white">
                ...
                <div className="space-y-4">
                  <div className="bg-white/20 backdrop-blur-sm p-4 rounded-lg">
                    ...
                    <div className="text-cyan-100 text-sm">Reduction in hiring time</div>
                  </div>
                  <div className="bg-white/20 backdrop-blur-sm p-4 rounded-lg">
                    <div className="text-2xl font-bold text-cyan-200">45%</div>
                    <div className="text-cyan-100 text-sm">Improvement in candidate matching</div>
                  </div>
                  <div className="bg-white/20 backdrop-blur-sm p-4 rounded-lg">
                    <div className="text-2xl font-bold text-cyan-200">70%</div>
                    <div className="text-cyan-100 text-sm">Process automation</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <p className="text-gray-700 mb-6 leading-relaxed">
                    ...
                    to extract, parse, and analyze candidate information from various document formats through
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center bg-gray-50 p-4 rounded-lg">
                      ...
                      <div>
                        <h5 className="font-semibold text-gray-900">Document Processing</h5>
                        <p className="text-gray-600 text-sm">PDF, DOCX, OCR, and format normalization</p>
                      </div>
                    </div>
                    <div className="flex items-center bg-gray-50 p-4 rounded-lg">
                      <Brain className="text-cyan-600 mr-3" size={20} />
                      <div>
                        <h5 className="font-semibold text-gray-900">Skill Extraction</h5>
                        <p className="text-gray-600 text-sm">NER, skill taxonomy, and proficiency assessment</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-cyan-50 p-6 rounded-lg border-l-4 border-cyan-500">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed">
                    ...
                    through weighted factors including technical competencies and cultural alignment.
                  </p>
                </div>
              </div>
            </section>
                ...
                {[
                  {
                    ...
                    description: "Domain-specific multiple-choice questions with adaptive difficulty scaling",
                    color: "bg-green-100 text-green-600"
                  },
                  {
                    icon: Cpu,
                    title: "Coding Challenges",
                    description: "Real-time coding environment with automated testing and code quality analysis",
                    color: "bg-purple-100 text-purple-600"
                  },
                  {
                    icon: Database,
                    title: "Project Simulations",
                    description: "Real-world scenario-based assessments evaluating problem-solving capabilities",
                    color: "bg-orange-100 text-orange-600"
                  }
                ].map((item, index) => (
                  <div key={index} className="text-center bg-gray-50 p-6 rounded-lg border border-gray-200 hover:border-cyan-300 transition-colors">
                    <div className={`${item.color} rounded-lg p-3 inline-flex mb-4`}>
                      <item.icon size={24} />
                    </div>
            ...
            <section className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-start">
                <div className="bg-gray-100 p-6 rounded-lg text-center">
                  ...
                  <p className="text-sm text-gray-600">Video Analysis Interface</p>
                </div>
                <div className="space-y-4">
                  {[
                    {
                      title: "Facial Expression Analysis",
                      description: "Emotion recognition and engagement level assessment through facial feature analysis",
                      border: "border-cyan-500"
                    },
                    {
                      title: "Speech Analytics",
                      description: "Tone analysis, speech clarity, and content coherence evaluation",
                      border: "border-green-500"
                    },
                    {
                      title: "Body Language Assessment",
                      description: "Posture, gestures, and eye contact analysis for communication effectiveness",
                      border: "border-purple-500"
                    }
                  ].map((feature, index) => (
                    <div key={index} className={`bg-white p-4 rounded-lg border-l-4 ${feature.border} shadow-sm`}>
            ...
            <section className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="prose prose-lg max-w-none text-gray-700 mb-8">
                <p className="mb-6 leading-relaxed">
                  This AI-powered agent addresses challenges in identifying in-demand skills in a rapidly
                  evolving job market. It facilitates smart job searching and targeted skill development
                  through data-driven, personalized recommendations based on real-time market analysis.
                </p>
              </div>

              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-cyan-50 p-6 rounded-lg border-l-4 border-cyan-500">
                  <h4 className="font-bold text-gray-900 mb-4">Core Functionality</h4>
                  <ul className="text-gray-700 space-y-3 text-sm">
                    <li className="flex items-start">
                      <span className="bg-cyan-600 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs mr-3 mt-0.5">1</span>
                      <span><strong>Real-Time Data Acquisition:</strong> Automated scraping from major job portals</span>
                    </li>
                    <li className="flex items-start">
                      <span className="bg-cyan-600 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs mr-3 mt-0.5">2</span>
                      <span><strong>Predictive Analytics:</strong> Prophet time-series forecasting for skill demand</span>
                    </li>
                    <li className="flex items-start">
                      <span className="bg-cyan-600 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs mr-3 mt-0.5">3</span>
                      <span><strong>Personalized Recommendations:</strong> Role-specific skill development guidance</span>
                    </li>
                  </ul>
                </div>

                <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-500">
                  <h4 className="font-bold text-gray-900 mb-4">System Features</h4>
                  <ul className="text-gray-700 space-y-3 text-sm">
                    <li className="flex items-start">
