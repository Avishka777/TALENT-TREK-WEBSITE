        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            ...
            <p className="mb-6">
              ...
              more sophisticated candidate evaluation methods. Research in automated resume parsing
              demonstrates the effectiveness of AI in extracting and analyzing candidate information,
              while studies on video interview analysis show promising results in assessing
              non-verbal communication and soft skills.
            </p>

            <p className="mb-6">
              The emergence of skill-based assessment platforms has transformed technical evaluation,
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h5 className="font-semibold text-gray-900 mb-2">AI-Agent for Smart Job Search and Automation</h5>
                  <p className="text-gray-700">
                    Design and implement an AI Skill Forecaster Analyzes IT job postings to predict the top 5 most in-demand skills for the next 6 months.
                  </p>
                </div>
              </div>
            </div>
