    ...
    <section id="research" className="py-20 bg-white ">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl">
        ...
        <div className="max-w-6xl mx-auto">
          {/* Main Introduction */}
          <div className="bg-gray-50 rounded-lg p-8 md:p-12 shadow-lg mb-12 border border-gray-200">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-red-500">
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-cyan-500">
              <div className="flex items-center mb-6">
          ...
          <div className="bg-green-50 rounded-lg p-8 border-l-4 border-green-500 shadow-lg">
